  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <p className="text-slate-600 mb-8">Updated: April 23, 2025</p>
        ...
        <div className="space-y-8 text-slate-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-slate-900 mb-4">1. Eligibility, Registration and Account</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-slate-900 mb-4">2. Communications Preferences</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-slate-900 mb-4">3. Our Services Offer a Venue</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-slate-900 mb-4">4. User Transactions; Release</h2>
            <p>
          ...
          <section>
            ...
            <h3 className="text-xl font-medium text-slate-900 mb-2">5.1. Coaching Sessions; Expiration; Cancelation</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-medium text-slate-900 mb-2">5.2. Gift Certificates</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-medium text-slate-900 mb-2">5.3. Payment and Billing Information</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-medium text-slate-900 mb-2">5.4. Pricing and Availability</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-medium text-slate-900 mb-2">5.5. Returns and Refunds</h3>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-slate-900 mb-4">6. Copyright and Limited License</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-slate-900 mb-4">7. Copyright Complaints</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-slate-900 mb-4">8. Trademarks</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-slate-900 mb-4">9. Third-Party Content</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-slate-900 mb-4">10. User Content and Interactive Areas</h2>
            <p>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-2">
              <li>User Content that is unlawful, libelous, defamatory, obscene, pornographic, indecent, lewd, suggestive, harassing, threatening, invasive of privacy or publicity rights, abusive, inflammatory, fraudulent, false, misleading, or otherwise objectionable;</li>
              ...
              <li>User Content that may infringe any patent, trademark, trade secret, copyright, or other proprietary right of any party;</li>
              ...
              <li>User Content that contains personal information about any person, including, without limitation, names, addresses, email address, or credit card information without that person’s permission;</li>
              <li>User Content that impersonates or misrepresents your affiliation with any person or entity;</li>
              ...
              <li>User Content that, in the sole judgment of Instacoach, is objectionable or that restricts or inhibits any other person from using or enjoying the Interactive Areas or our Services, or which may expose Instacoach or its users to any harm or liability of any type.</li>
            </ul>
            <p className="mt-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-slate-900 mb-4">11. Rights to User Content</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-slate-900 mb-4">12. Acceptable Use of Our Services</h2>
            <p>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-2">
              ...
              <li>Engage in any discriminatory, defamatory, hateful, harassing, abusive, obscene, threatening, physically dangerous, or otherwise objectionable conduct;</li>
              <li>Attempt to indicate in any manner that you have a relationship with Instacoach or that Instacoach has endorsed you or any services for any purpose unless Instacoach has provided written permission to do so;</li>
              <li>Send any unsolicited or unauthorized advertising, solicitations, promotional materials, spam, junk mail, chain letters, or pyramid schemes, or harvest or collect the email addresses or other contact information of other users for the purpose of sending spam or other commercial messages;</li>
              <li>Attempt to reverse engineer any aspect of our Services or do anything that might discover source code or bypass or circumvent measures employed to prevent or limit access to any area, content, or code of our Services (except as otherwise expressly permitted by law);</li>
              <li>Access, use, or attempt to access or use another's account without authorization from such user and Instacoach;</li>
              <li>Develop any third-party application that interacts with User Content or our Services without Instacoach’s prior written consent;</li>
              <li>Use any robot, iframe, spider, crawler, scraper, or other automated means or interface not provided or authorized by Instacoach to access out Services, including, without limitation, for the purpose of copying, extracting, aggregating, displaying, publishing, or distributing any content or data made available via our Services;</li>
              <li>Bypass or ignore instructions contained in the robots.txt file, accessible at www.Instacoach.com/robots.txt, that controls all automated access to our Services; or</li>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-slate-900 mb-4">13. Feedback</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-slate-900 mb-4">15. Disclaimers</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-slate-900 mb-4">16. Limitation of Liability</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-slate-900 mb-4">17. Assumption of Risk</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-slate-900 mb-4">18. Modifications to Our Services</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-slate-900 mb-4">19. Dispute Resolution; Arbitration</h2>
            ...
            <h3 className="text-xl font-medium text-slate-900 mb-2">19.1. Binding Arbitration</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-medium text-slate-900 mb-2">19.2. No Class Arbitrations, Class Actions or Representative Actions</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-medium text-slate-900 mb-2">19.3. Federal Arbitration Act</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-medium text-slate-900 mb-2">19.4. Notice; Informal Dispute Resolution</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-medium text-slate-900 mb-2">19.5. Process</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-medium text-slate-900 mb-2">19.6. Authority of Arbitrator</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-medium text-slate-900 mb-2">19.7. Rules of JAMS</h3>
            <p className="mb-4">
              The rules of JAMS and additional information about JAMS are available on the JAMS website. By agreeing to be bound by these Terms, you either (a) acknowledge and agree that you have read and understand the rules of JAMS, or (b) waive your opportunity to read the rules of JAMS and any claim that the rules of JAMS are unfair or should not apply for any reason.
            </p>

            <h3 className="text-xl font-medium text-slate-900 mb-2">19.8. Severability</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-medium text-slate-900 mb-2">19.9 Opt-Out Right</h3>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-slate-900 mb-4">20. Applicable Law and Venue</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-slate-900 mb-4">21. Termination</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-slate-900 mb-4">22. Changes to These Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-slate-900 mb-4">23. Severability</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-slate-900 mb-4">24. Notice for California Users</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-slate-900 mb-4">25. Miscellaneous</h2>
            <p>
